...
public static class Specification
{
    public static Contract<Notification> Ensure(Request request)
        => new Contract<Notification>()
            ...
            .IsLowerThan(request.Name.Length, 256, "Name", "O nome deve conter menos de 256 caracteres")
            .IsGreaterThan(request.Name.Length, 2, "Name", "O nome deve conter mais de 2 caracteres")
            ...
            .IsNotNull(request.OccupationId, "OccupationId", "A ocupação profissional deve ser informada")
